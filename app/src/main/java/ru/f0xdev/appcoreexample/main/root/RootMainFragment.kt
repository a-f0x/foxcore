package ru.f0xdev.appcoreexample.main.root
...
import ru.f0xdev.appcoreexample.main.chats.ChatsListFragment
import ru.f0xdev.appcoreexample.main.settings.SettingsFragment
import ru.f0xdev.appcoreexample.main.users.UsersListFragment
